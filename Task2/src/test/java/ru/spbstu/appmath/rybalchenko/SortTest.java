...
public class SortTest <T> {
    ...
    public static Human[] randomHumanData() {
        String[] names = new String[]{"Sergey", "Alexander", "Andreas", "Juan", "Quique", "Leha", "Max", "Nick", "John", "Bob", "Martin"};
        Random rand = new Random();
    ...
    private static final Object[][] TEST_DATA = {
            ...
            {Bubble_Sort, new Human[]{new Human("Sergio",3), new Human ("Alex",1), new Human ("Mart",2),//5
                    new Human ("Smirnovsky",7)}, HUMAN_COMPARATOR_AGE},
            {Bubble_Sort, new Human[]{new Human("Anya",32), new Human ("Vika",24), new Human ("Kate",14),//6
                    new Human ("Maks",25)}, HUMAN_COMPARATOR_NAME}
    };
